...
/** @param {string} baseUrl @param {string} bearerToken @param {{signal?: AbortSignal, onState?: (state: any) => void}} [options] */
...
/** @param {string} frame @param {(state: any) => void} [onState] */
